...
const About = () => {
  return (
    <div className="bg-black h-screen w-full flex justify-center items-center px-24 py-20 text-white" id="about">
      <div className="flex flex-col items-center justify-center h-full w-1/3 border border-white">
        <div className="flex flex-col items-center justify-center h-1/2 w-full border px-6">
          <p className="mb-4 font-bold text-2xl">What is an NFT?</p>
        ...
        <div className="flex flex-col items-center justify-center h-1/2 w-full border py-10">
          <div className="flex flex-col justify-center items-center">
            ...
            <SlPicture className="w-24 h-24" />
          </div>
        </div>
      </div>

      <div className="flex flex-col items-center justify-start h-full w-2/3 border border-white">
        <div className="flex flex-col items-center justify-center h-3/4 w-full border border-white px-16 py-6">
          <p className="text-4xl font-bold mb-6">About Our Collections</p>
          <p className="tracking-wide leading-8 text-center">
        ...
        <div className="border h-1/4 w-full flex justify-center items-center">
